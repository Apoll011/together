      ...
      <div className="page-center">
        <div className="auth-card card">
          ...
          <div className="alert alert-success">
            ...
            <br />
            We sent a verification link to <strong>{email}</strong>. You must verify your email before signing in.
          </div>
          <p style={{ fontSize: ".875rem", color: "#6b7280" }}>
            Didn&apos;t get it? <Link href={`/verify-email?resend=true&email=${encodeURIComponent(email)}`}>Resend verification</Link>
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="page-center">
      <div className="auth-card card">
        ...
        <p className="subtitle">Get started with Together.</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="field">
            ...
            <input id="confirm" className="input" type="password" autoComplete="new-password" required value={confirm} onChange={(e) => setConfirm(e.target.value)} />
          </div>

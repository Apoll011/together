    ...
    <section style={{ padding: "80px 24px 120px", background: colors.navBg }}>
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        >
          ...
          <Title level={2} style={{ color: "#fff", fontSize: "clamp(28px, 4vw, 48px)", marginBottom: 24 }}>
            Ready to join the movement?
          </Title>
          <Paragraph style={{ color: "rgba(255,255,255,0.85)", fontSize: 18, maxWidth: 600, margin: "0 auto 40px" }}>
            Start preserving data, learning together, and building tools for a sustainable future today.
          </Paragraph>
          
          <Button 
            size="large" 
            style={{ height: 56, padding: "0 40px", fontSize: 16, border: "none" }}
          >
